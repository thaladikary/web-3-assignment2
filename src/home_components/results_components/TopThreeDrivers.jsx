...
const TopThreeDrivers = () => {
  const {selectedRace,setSelectedRace,topDrivers, setTopDrivers} = useContext(AppContext);
  ...
  return (
    ...
    <div className={'bg-grap-900 flex flex-row py-6'}>
      {!topDrivers ? (<CircularProgress className="m-8" />) : (
        <div className="flex w-full">
            <div className={'flex-1 justify-end mx-auto gap-4 pl-40'}>
            <img src="https://placehold.co/100x100" alt="Your alt text" className="h-12 w-12 rounded-full mx-auto" />
          ...
          <div className={'flex-1 gap-6'}>
            <img src="https://placehold.co/100x100" alt="Your alt text" className="h-20 w-20 rounded-full mx-auto" />
